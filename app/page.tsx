...
export default function Home() {
    const assets = clients.reduce((a, c) => a + c.assets, 0);
    return (
...
function Stat({label, number, hint,}: {label: string; number: number; hint: string;}) {
    return (
        <div className="stat">
...
function Project({title, sub, status, tone, variant = "",}: {title: string; sub: string; status: string; tone: string; variant?: string;}) {
    return (
